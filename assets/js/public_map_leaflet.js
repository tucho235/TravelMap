            ...
            onEachFeature: function (feature, lyr) {
                ...
                lyr.bindPopup(`
                    <div class="route-popup">
                        ${(route.image_url || route.imageUrl) ? `<img src="${route.image_url || route.imageUrl}" alt="" style="width: 100%; max-height: 150px; object-fit: cover; margin-bottom: 8px; border-radius: 4px;">` : ''}
